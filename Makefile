...
APPS = iriw_poonceonces_onceonce r_poonceonces sb_poonceonces sb_fencembonceonces mp_pooncerelease_poacquireonce mp_poonceonces dep_plain wrc_poonceonces_once wrc_pooncerelease_fencermbonceonce_once
