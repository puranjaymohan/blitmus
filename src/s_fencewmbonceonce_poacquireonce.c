/* Auto-generated from S+fencewmbonceonce+poacquireonce.litmus */
...
#include "s_fencewmbonceonce_poacquireonce.skel.h"
#define THREADS 2
#define TEST_NAME s_fencewmbonceonce_poacquireonce
#define TEST_NAME_PRINT "S+fencewmbonceonce+poacquireonce"
