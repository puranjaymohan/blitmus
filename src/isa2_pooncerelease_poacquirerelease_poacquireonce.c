/* Auto-generated from ISA2+pooncerelease+poacquirerelease+poacquireonce.litmus */
...
#include "isa2_pooncerelease_poacquirerelease_poacquireonce.skel.h"
#define THREADS 3
#define TEST_NAME isa2_pooncerelease_poacquirerelease_poacquireonce
#define TEST_NAME_PRINT "ISA2+pooncerelease+poacquirerelease+poacquireonce"
...
static void check_cond (STRUCT_NAME(TEST_NAME) *skel,
	...
	int p2_r0 = skel->bss->shared.r2[c];
	int p2_r1 = skel->bss->shared.r3[c];
