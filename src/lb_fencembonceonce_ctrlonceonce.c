/* Auto-generated from LB+fencembonceonce+ctrlonceonce.litmus */
...
#include "lb_fencembonceonce_ctrlonceonce.skel.h"
#define THREADS 2
#define TEST_NAME lb_fencembonceonce_ctrlonceonce
#define TEST_NAME_PRINT "LB+fencembonceonce+ctrlonceonce"
#define EXISTS_CLAUSE "0:r0=1 /\\ 1:r0=1"
unsigned long long states[10][10] = {0};
...
static void check_cond (STRUCT_NAME(TEST_NAME) *skel,
	...
	unsigned long long p0_r0 = skel->bss->shared.r1[c];
	unsigned long long p1_r0 = skel->bss->shared.r2[c];
	// Check if this iteration matches the exists clause
	states[p0_r0][p1_r0]++;
	if (p0_r0 == 1 && p1_r0 == 1) {
			*matches += 1;
			expected_state_p = &states[p0_r0][p1_r0];
	} else {
			*non_matches += 1;
	}
}
const char* var_names[] = {"p0_r0", "p1_r0"};
