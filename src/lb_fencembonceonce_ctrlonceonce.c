...
const char *cond_vars_str[2] = {"0:r0", "1:r0"};
...
static void check_cond (STRUCT_NAME(TEST_NAME) *skel, unsigned long long *matches,
	...
	unsigned long long P0_r0 = skel->bss->shared.P0_r0[c];
	...
	key_values[0] = skel->bss->shared.P0_r0[c];
	key_values[1] = skel->bss->shared.P1_r0[c];
