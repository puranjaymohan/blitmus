/* Auto-generated from LB+poacquireonce+pooncerelease.litmus */
...
#include "lb_poacquireonce_pooncerelease.skel.h"
#define THREADS 2
#define TEST_NAME lb_poacquireonce_pooncerelease
#define TEST_NAME_PRINT "LB+poacquireonce+pooncerelease"
