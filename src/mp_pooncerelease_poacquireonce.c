...
#include "mp_pooncerelease_poacquireonce.skel.h"
#define THREADS 2
#define TEST_NAME mp_pooncerelease_poacquireonce
#define TEST_NAME_PRINT "MP+pooncerelease+poacquireonce"
#define EXISTS_CLAUSE "1:r0=1 /\\ 1:r1=0"
...
static void check_cond (STRUCT_NAME(TEST_NAME) *skel,
	...
	if (p1_r0 == 1 && p1_r1 == 0) {
			*matches += 1;
			expected_state_p = &states[p1_r0][p1_r1];
	} else {
			*non_matches += 1;
	}
}
const char* var_names[] = {"p1_r0", "p1_r1"};
