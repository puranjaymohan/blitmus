/* Auto-generated from S+poonceonces.litmus */
...
#include "s_poonceonces.skel.h"
#define THREADS 2
#define TEST_NAME s_poonceonces
#define TEST_NAME_PRINT "S+poonceonces"
#define EXISTS_CLAUSE "1:r0=1 /\\ x=2"
