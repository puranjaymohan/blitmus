/* Auto-generated from WRC+pooncerelease+fencermbonceonce+Once.litmus */
...
#include "wrc_pooncerelease_fencermbonceonce_once.skel.h"
#define THREADS 3
#define TEST_NAME wrc_pooncerelease_fencermbonceonce_once
#define TEST_NAME_PRINT "WRC+pooncerelease+fencermbonceonce+Once"
