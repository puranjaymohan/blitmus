...
/* Auto-generated from IRIW+fencembonceonces+OnceOnce.litmus */
...
#include "iriw_fencembonceonces_onceonce.skel.h"
#define THREADS 4
#define TEST_NAME iriw_fencembonceonces_onceonce
#define TEST_NAME_PRINT "IRIW+fencembonceonces+OnceOnce"
...
const char *cond_vars_str[4] = {"1:r0", "1:r1", "3:r0", "3:r1"};
...
static void check_cond (STRUCT_NAME(TEST_NAME) *skel, unsigned long long *matches,
	...
	unsigned long long P1_r1 = skel->bss->shared.P1_r1[c];
	unsigned long long P3_r0 = skel->bss->shared.P3_r0[c];
	unsigned long long P3_r1 = skel->bss->shared.P3_r1[c];
	...
	key_values[1] = skel->bss->shared.P1_r1[c];
	key_values[2] = skel->bss->shared.P3_r0[c];
	key_values[3] = skel->bss->shared.P3_r1[c];
