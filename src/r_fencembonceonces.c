...
/* Auto-generated from R+fencembonceonces.litmus */
...
#include "r_fencembonceonces.skel.h"
#define THREADS 2
#define TEST_NAME r_fencembonceonces
#define TEST_NAME_PRINT "R+fencembonceonces"
...
const char *cond_vars_str[2] = {"1:r0", "y"};
