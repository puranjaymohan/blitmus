/* Auto-generated from IRIW+poacquireacquire+releaserelease.litmus */
...
#include "iriw_poacquireacquire_releaserelease.skel.h"
#define THREADS 4
#define TEST_NAME iriw_poacquireacquire_releaserelease
#define TEST_NAME_PRINT "IRIW+poacquireacquire+releaserelease"
#define EXISTS_CLAUSE "1:r0=1 /\\ 1:r1=0 /\\ 3:r0=1 /\\ 3:r1=0"
unsigned long long states[10][10][10][10] = {0};
...
static void check_cond (STRUCT_NAME(TEST_NAME) *skel,
	...
	unsigned long long p1_r1 = skel->bss->shared.r2[c];
	unsigned long long p3_r0 = skel->bss->shared.r3[c];
	unsigned long long p3_r1 = skel->bss->shared.r4[c];
