...
/* Auto-generated from CoWR+poonceonce+Once.litmus */
...
#include "cowr_poonceonce_once.skel.h"
#define THREADS 2
#define TEST_NAME cowr_poonceonce_once
#define TEST_NAME_PRINT "CoWR+poonceonce+Once"
#define EXISTS_CLAUSE "x=1 /\\ 0:r0=2"
...
const char *cond_vars_str[2] = {"0:r0", "x"};
...
static void check_cond (STRUCT_NAME(TEST_NAME) *skel, unsigned long long *matches,
	...
	unsigned long long x = skel->bss->shared.x[c];
	...
	key_values[1] = skel->bss->shared.x[c];
